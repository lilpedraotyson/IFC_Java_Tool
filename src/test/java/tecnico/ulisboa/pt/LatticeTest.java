...
public class LatticeTest {
    ...
    public void test3() throws IOException {
        Lattice lattice = new Lattice(new File("target/test-classes/tests/lattice.txt"));
        ASTParserClass ast = new ASTParserClass(lattice, "target/test-classes/tests/ClassTest.java");
        ASTParserClass ast1 = new ASTParserClass(lattice, "target/test-classes/tests/ClassTest1.java");
        ASTParserClass ast2 = new ASTParserClass(lattice, "target/test-classes/tests/ClassTest2.java");
