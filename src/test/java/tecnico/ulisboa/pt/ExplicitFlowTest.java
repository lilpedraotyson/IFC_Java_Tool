...
public class ExplicitFlowTest {
    ...
    public void test1() throws IOException {
        ...
        ASTParserClass ast = new ASTParserClass(lattice, "target/test-classes/tests/ExplicitTest.java");
        ASTParserClass ast1 = new ASTParserClass(lattice1, "target/test-classes/tests/ExplicitTest.java");
    ...
    public void test2() throws IOException {
        ...
        ASTParserClass ast = new ASTParserClass(lattice, "target/test-classes/tests/ExplicitTest1.java");
